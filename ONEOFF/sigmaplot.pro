...
; FOR rend = rendstart,rendend,rendskip DO BEGIN
 
  rend = rendstart
     CASE count OF
         0: titlestr = "SHALLOW P = 1/2"
         1: titlestr = "MODERATE P = 1"
         2: titlestr = "STEEP P = 3/2"
         ELSE: print, "You screwed up dummy!"
     ENDCASE


     getfile = STRING(datadir,prefix,".",rend,FORMAT = '(A,A,A1,I6.6)') 
     ...
     modelstr = string("Model = G1.7TC2P.5")
