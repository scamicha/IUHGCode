...
!     Strings are set to 80 characters, if you need a longer path
!     resize them here.
      ...
      integer  lmax,lmax2,mmax
      integer  pot3jmax,pot3jmax1,pot3jmax2
      integer  pot3kmax,pot3kmax1,pot3kmax2
      integer  jmin,jmin1,jmin2

!     datadir is the location of the saved files, 
!     outdir the directory where outfile will be written

      parameter (datadir = '../WAN_DATA/')
      parameter (outdir  = './')
      parameter (outfile = 'Qplot_baseline.')
      real*8, PARAMETER :: time1 = 0.d0, time2 = 22.d0
...
!     ISTART is the first file IEND the last one, and ISKIP the interval
...
!     correctly. pot3jmax and pot3kmax should be the same as JMAX and KMAX
      ...
      parameter (ISTART=0005000,IEND=0545000,ISKIP=5000)
      parameter (kmax= 32, kmax1=kmax+1, kmax2=kmax+2)
