...
C$OMP THREADPRIVATE(/BLOK6/,/BDY/,/BDY1/)
C                                                                       
C                                                                       
      ISYMA = IABS(ISYM)
      IF(NCALL.EQ.0) THEN
...
C$OMP&  COPYIN(/BLOK6/,/GRID/,/BDY/,/BDY1/)
...
c      enddo                                             !dkb debug
c 9000 format(i4,1p12e14.5,/,(4x,1p12e14.5))             !dkb debug

c      do jk = 1,jkmax                                               !DKB debug
c        jj = jpos(jk)                                               !DKB debug
c        kk = kpos(jk)                                               !DKB debug
c        rspher = rbdy(jk)                                           !DKB debug
c        write(22,9020) jk,jj,kk,rspher,phi(jj,kk,2)                  !DKB debug
c      enddo                                                         !DKB debug
c 9020 format('JK=',i3,'  JJ=',i3,'  KK=',i3,'  RSPHER=',1pe13.5,    !DKB debug
