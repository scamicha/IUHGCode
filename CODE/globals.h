...
C     
      ...
      integer jin,itype
      real*8 tmassini,tmassadd,tmassout,tmassacc,mass_star
      real*8 starphi,tinphi
      COMMON /GAP/starphi(jmax2,kmax2,lmax),
     &     tinphi(jmax2,kmax2,lmax),
     &     tmassini,tmassadd,tmassout,tmassacc,mass_star,
     &     jin,itype
     ...
     &          int_temp,init_int_in 
      common /intensity/ KFITA(JMAX,LMAX),
